    ...
    : G4VUserDetectorConstruction(),fAnticShieldVolume(0),fAnticShieldVolume2(0),fBeWindowsVolume(0),fGasVolume(0)
{
  ...
  fDetPar[WORLD]->visAtt = new G4VisAttributes(G4Colour(1, 1, 1, 0.9));
  ...
  fDetPar[SHIELD1]->Matt = "G4_Galactic";
  ...
  fDetPar[SHIELD1]->visAtt = new G4VisAttributes(G4Colour(0.5, 0.5, 0.5, 0.2));
  ...
  //fDetPar[KOVAR2]->Matt = "G4_Galactic";
  ...
  fDetPar[15]->Name = "Kovar22";
  fDetPar[15]->VType = "Tub";
  fDetPar[15]->Matt = "G4_Galactic";
  //fDetPar[KOVAR2]->Matt = "G4_Galactic";
  fDetPar[15]->MID = KOVAR2;
  fDetPar[15]->Siz[0] = 5 * mm;
  fDetPar[15]->Siz[1] = 1 * mm;
  //fDetPar[15]->Siz[2] = 1 * mm;
  fDetPar[15]->Pos[0] = 0 * mm;
  fDetPar[15]->Pos[1] = 0 * mm;
  fDetPar[15]->Pos[2] = 0 * mm;
  fDetPar[15]->visAtt = new G4VisAttributes(G4Colour(1.0, 0.0, 0.0, 0.2));
  fDetPar[15]->visAtt->SetVisibility(true);
  fDetPar[15]->visAtt->SetForceSolid(true);
  fDetPar[15]->Material = NULL;
  fDetPar[15]->Region = NULL;
  fDetPar[15]->RegionName = fDetPar[15]->Name + "_Region";
  SetMaterial(15, fDetPar[15]->Matt);

  fDetPar[ANTICSHIELD]->Name = "AntiShield";
  fDetPar[ANTICSHIELD]->VType = "Box";
  //fDetPar[ANTICSHIELD]->Matt = "GAGG";
  fDetPar[ANTICSHIELD]->Matt = "G4_Galactic";
  ...
  fDetPar[ANTICSHIELD]->visAtt = new G4VisAttributes(G4Colour(1.0, 0, 1, 0.2));
  ...
  fDetPar[KOVAR1]->Matt = "G4_Galactic";
  fDetPar[KOVAR1]->MID = SHIELD1;
  fDetPar[KOVAR1]->Siz[0] = 6 * mm;
  fDetPar[KOVAR1]->Siz[1] = 8.66 * mm;
  //fDetPar[KOVAR1]->Siz[2] = 27.5 * mm;
  fDetPar[KOVAR1]->Pos[0] = 0 * mm;
  fDetPar[KOVAR1]->Pos[1] = 0 * mm;
  fDetPar[KOVAR1]->Pos[2] = 13.66 * mm;
  fDetPar[KOVAR1]->visAtt = new G4VisAttributes(G4Colour(1.0, 1.0, 0.0, 0.2));
  ...
  fDetPar[COLLIMATION1]->Siz[0] = 5 * mm;
  fDetPar[COLLIMATION1]->Siz[1] = 8.66 * mm;
  ...
  fDetPar[COLLIMATION1]->visAtt = new G4VisAttributes(G4Colour(0, 0, 1.0, 0.2));
  ...
  fDetPar[WINDOW]->Matt = "G4_Galactic";
  //fDetPar[WINDOW]->Matt = "Galactic";
  fDetPar[WINDOW]->MID = COLLIMATION1;
  fDetPar[WINDOW]->Siz[0] = 5 * mm;
  fDetPar[WINDOW]->Siz[1] = 0.025 * mm;
  //fDetPar[WINDOW]->Siz[2] = 0.025 * mm;
  fDetPar[WINDOW]->Pos[0] = 0 * mm;
  fDetPar[WINDOW]->Pos[1] = 0 * mm;
  fDetPar[WINDOW]->Pos[2] = -8.635 * mm;
  fDetPar[WINDOW]->Rot[0] = 0;
  fDetPar[WINDOW]->Rot[1] = 0;
  fDetPar[WINDOW]->Rot[2] = 0;
  fDetPar[WINDOW]->visAtt = new G4VisAttributes(G4Colour(1, 0, 0, 0.3));
  ...
  fDetPar[CERAMICS]->visAtt = new G4VisAttributes(G4Colour(0, 1.0, 0, 0.2));
  ...
  fDetPar[GAS]->VType = "Tub";
  fDetPar[GAS]->Matt = "Ne_50_DME_50";
  fDetPar[GAS]->MID = CERAMICS;
  fDetPar[GAS]->Siz[0] = 13.25 * mm;
  fDetPar[GAS]->Siz[1] = 5 * mm;
  ...
  fDetPar[GAS]->Rot[1] = 0;
  fDetPar[GAS]->Rot[2] = 0;
  fDetPar[GAS]->visAtt = new G4VisAttributes(G4Colour(1, 1, 1, 0.7));
  ...
  fDetPar[KOVAR3]->visAtt = new G4VisAttributes(G4Colour(1.0, 1.0, 0, 0.2));
  ...
  fDetPar[ANTICSHIELD2]->visAtt = new G4VisAttributes(G4Colour(1.0, 0, 1, 0.2));
...
G4VPhysicalVolume *MyDetectorConstruction::DefineVolumes()
{
  ...
  */
  ...
  fSolid[KOVAR1] = new G4Tubs(fDetPar[KOVAR1]->Name,0.,fDetPar[KOVAR1]->Siz[0],fDetPar[KOVAR1]->Siz[1],0.*deg,360.*deg);
  ...
  fSolid[COLLIMATION1] = new G4Tubs(fDetPar[COLLIMATION1]->Name,0.,fDetPar[COLLIMATION1]->Siz[0],fDetPar[COLLIMATION1]->Siz[1],0.*deg,360.*deg);
  ...
  fSolid[WINDOW] = new G4Tubs(fDetPar[WINDOW]->Name,0.,fDetPar[WINDOW]->Siz[0],fDetPar[WINDOW]->Siz[1],0.*deg,360.*deg);
  ...
  fSolid[15] = new G4Tubs(fDetPar[15]->Name,0.,fDetPar[15]->Siz[0],fDetPar[15]->Siz[1],0.*deg,360.*deg);

  fLogic[15] = new G4LogicalVolume(fSolid[15], fDetPar[15]->Material, fDetPar[15]->Name);

  fPhysc[15] = new G4PVPlacement(0,
                                           G4ThreeVector(fDetPar[15]->Pos[0], fDetPar[15]->Pos[1], fDetPar[15]->Pos[2]),
                                           fLogic[15], fDetPar[15]->Name,
                                           fLogic[fDetPar[15]->MID], false, checkOverlaps);
  ...
  fSolid[GAS] = new G4Tubs(fDetPar[GAS]->Name,0.,fDetPar[GAS]->Siz[0],fDetPar[GAS]->Siz[1],0.*deg,360.*deg);
  ...
  fLogic[15]->SetVisAttributes(fDetPar[15]->visAtt);
  return fPhysc[WORLD];
}
