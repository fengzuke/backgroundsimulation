...
{
	G4ProductionCutsTable::GetProductionCutsTable()->SetEnergyRange(10. * eV,
			100. * TeV);
    SetCutsWithDefault();
	...
	cuts->SetProductionCut(100 * um, G4ProductionCuts::GetIndex("gamma"));
	cuts->SetProductionCut(3 * um, G4ProductionCuts::GetIndex("e-"));
	cuts->SetProductionCut(100 * um, G4ProductionCuts::GetIndex("e+"));
	cuts->SetProductionCut(100 * um, G4ProductionCuts::GetIndex("proton"));
	if (region) {
