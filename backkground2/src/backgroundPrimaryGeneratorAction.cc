...
// ********************************************************************
//
// $Id: backgroundPrimaryGeneratorAction.cc 94307 2015-11-11 13:42:46Z gcosmo $
//
/// \file backgroundPrimaryGeneratorAction.cc
/// \brief Implementation of the backgroundPrimaryGeneratorAction class
...
void backgroundPrimaryGeneratorAction::GeneratePrimaries(G4Event* anEvent)
{
  // G4double size = 0.8; 
